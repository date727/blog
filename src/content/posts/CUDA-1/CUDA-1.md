...
- [你好，未来的ai架构师](#你好未来的ai架构师)
	- [引言](#引言)
	- [WHAT IS CUDA？（多层含义）](#what-is-cuda多层含义)
	- [INTRODUCTION TO CUDA C++（课程内容）](#introduction-to-cuda-c课程内容)
	- [专业术语](#专业术语)
	- [PORTING TO CUDA](#porting-to-cuda)
	- [向量加法简述](#向量加法简述)
	- [语法讲解](#语法讲解)
		- [\_global\_关键字](#_global_关键字)
		- [函数调用：内核启动语法](#函数调用内核启动语法)
		- [内存管理](#内存管理)
	- [向量加法实践](#向量加法实践)
	- [线程](#线程)
	- [同时使用块与线程](#同时使用块与线程)
